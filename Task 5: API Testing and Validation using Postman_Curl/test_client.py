...
def run_api_tests():
    ...
    # 3. Test Valid Single Sample Prediction (14 Features)
    ...
    # 4. Test Valid Batch Predictions (2 Samples, 14 Features each)
    ...
    # 5. Test Valid Dict Key-Value Feature Payload Pattern (14 Features)
